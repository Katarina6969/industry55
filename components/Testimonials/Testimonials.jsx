        ...
        <section className="my-8  bg-white text-black">
            <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
                ...
                <div className="flex justify-center space-x-3">
                    <Image src="https://source.unsplash.com/80x80/?portrait?1" alt="" className="w-20 h-20 bg-center bg-cover rounded-md" />
                    <div>
                        <p className="leading-tight">Leroy Jenkins</p>
                        <p className="text-sm leading-tight dark:text-gray-300">Founder, Company</p>
